...
class DotenvOp < Formula
  ...
  url "https://github.com/Kinoba/dotenv-op/releases/download/v1.2.0/dotenv-op.tar.gz"
  sha256 "b805a9dd7298df7cf166bf30002553d2cab24957daa82511948a5ef44bc1a7e2"
  license "MIT"
